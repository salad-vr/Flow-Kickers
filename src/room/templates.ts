...
export function cornerFedRoom(): Room {
  ...
  ], floor: [{ x, y }, { x: x + w, y }, { x: x + w, y: y + h }, { x, y: y + h }], entryPoints: [{ x: x + 80, y: y + h + 40 }], objects: [], floorCut: [] };
}
...
export function centerFedRoom(): Room {
  ...
  ], floor: [{ x, y }, { x: x + w, y }, { x: x + w, y: y + h }, { x, y: y + h }], entryPoints: [{ x: x + w / 2, y: y + h + 40 }], objects: [], floorCut: [] };
}
...
export function lShapeRoom(): Room {
  ...
  ], floor: [{ x, y },{ x: x+360, y },{ x: x+360, y: y+140 },{ x: x+200, y: y+140 },{ x: x+200, y: y+280 },{ x, y: y+280 }], entryPoints: [{ x: x + 100, y: y + 280 + 40 }], objects: [], floorCut: [] };
}
...
export function tShapeRoom(): Room {
  ...
  ], floor: [{ x, y },{ x: x+400, y },{ x: x+400, y: y+100 },{ x: x+250, y: y+100 },{ x: x+250, y: y+260 },{ x: x+150, y: y+260 },{ x: x+150, y: y+100 },{ x, y: y+100 }], entryPoints: [{ x: x + 200, y: y + 260 + 40 }], objects: [], floorCut: [] };
}
